    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 order-md-1">
                ...
                <form enctype="multipart/form-data" action="{{ route('bunga.masuk.update', $id->id) }}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $id->nama_bunga }}" name="nama_bunga" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" value="{{ $id->harga_bunga }}" name="harga_bunga" class="form-control"
                            id="harga_bunga" placeholder="harga bunga">
                        @error('harga_bunga')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
